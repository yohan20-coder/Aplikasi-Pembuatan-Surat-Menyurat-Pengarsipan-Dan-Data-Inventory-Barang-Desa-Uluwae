  ...
  td{
   ...
   font-weight : bold;
        ...
        <?= $this->session->flashdata('message');?>
          ...
          <a href="<?= base_url('layanan/surkel'); ?>" class="btn btn-primary btn-sm mb-3">Kembali</a>
                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <td>
                            ...
                            <?php }else{ ?>
                              <a target="blank" href="<?= base_url();?>layanan/print/<?= $sm['id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-fw fa-print"></i></a>
                              <a href="<?= base_url();?>layanan/hapusss/<?= $sm['id'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-fw fa-trash"></i></a>
                            <?php } ?>
                          </td>
                      </tr>
                  <?php $no++ ?>
