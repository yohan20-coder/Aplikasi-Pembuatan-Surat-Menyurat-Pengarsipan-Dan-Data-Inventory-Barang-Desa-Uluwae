                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <td>
                            ...
                            <?php }else{ ?>
                              <a target="blank" href="<?= base_url();?>layanan/cetakkk/<?= $sm['id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-fw fa-print"></i></a>
                              <a href="<?= base_url();?>layanan/hapuss/<?= $sm['id'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-fw fa-trash"></i></a>
                            <?php } ?>
                          </td>
                      </tr>
                  <?php $no++ ?>
