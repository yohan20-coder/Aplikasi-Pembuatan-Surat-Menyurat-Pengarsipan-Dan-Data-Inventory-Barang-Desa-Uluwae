  ...
  td{
   ...
   font-weight : bold;
        ...
        <?= $this->session->flashdata('message');?>
          ...
          <a href="<?= base_url('layanan/ketusaha'); ?>" class="btn btn-primary btn-sm mb-3">Kembali</a>
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">N. Pemilik Usaha</th>
                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <td>
                            ...
                            <?php }else{ ?>
                              <a target="blank" href="<?= base_url();?>layanan/cetakk/<?= $sm['id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-fw fa-print"></i></a>
                              <a href="<?= base_url();?>layanan/hapus/<?= $sm['id'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-fw fa-trash"></i></a>
                            <?php } ?>
                          </td>
                      </tr>
