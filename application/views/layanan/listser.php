  ...
  td{
   ...
   font-weight : bold;
        ...
        <?= $this->session->flashdata('message');?>
          ...
          <a href="<?= base_url('layanan/sertifikat'); ?>" class="btn btn-primary btn-sm mb-3">Kembali</a>
          ...
          <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">N. Pemilik Tanah</th>
                    ...
                    <?php foreach($tampil as $sm): ?>
                      <tr>
                          ...
                          <td>
                            ...
                            <?php }else{ ?>
                              <a target="blank" href="<?= base_url();?>layanan/cetakser/<?= $sm['id'] ?>" class="btn btn-info btn-sm"><i class="fas fa-fw fa-print"></i></a>
                              <a href="<?= base_url();?>layanan/hapussertifikat/<?= $sm['id'] ?>" class="btn btn-danger btn-sm"><i class="fas fa-fw fa-trash"></i></a>
                            <?php } ?>
                          </td>
                      </tr>
                  <?php $no++ ?>
