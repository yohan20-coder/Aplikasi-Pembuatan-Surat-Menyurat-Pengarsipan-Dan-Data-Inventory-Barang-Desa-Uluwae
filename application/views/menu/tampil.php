                    ...
                    <?php foreach($role as $sm): ?>
                      <tr>
                          ...
                          <td>
                              ...
                              <!-- <a href="#" class="btn btn-danger btn-sm" onclick="return confirm('Mohon Maaf Anda tidak dapat menghapus User karena ini Project Demo \n By Andi yang Tamvan ');">Hapus</a> -->
                          </td>
                      </tr>
                  <?php $no++ ?>
                  <?php endforeach ?>
