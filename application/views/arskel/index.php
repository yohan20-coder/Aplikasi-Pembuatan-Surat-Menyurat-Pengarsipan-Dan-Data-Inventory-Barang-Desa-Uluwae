...
?>
        ...
        <?= $this->session->flashdata('message');?>
         ...
         <!--  <a href="<?= base_url('arsip/pdfm2');?>" class="btn btn-success btn-sm mb-3" target="blank">Print Pdf</a> -->
          <a href="<?= base_url('arsip/cetak2');?>" class="btn btn-warning btn-sm mb-3" target="blank">Print</a>
           <a href="<?= base_url('arsip/cet_periode');?>" class="btn btn-info btn-sm mb-3" target="blank">Print Periode</a>
