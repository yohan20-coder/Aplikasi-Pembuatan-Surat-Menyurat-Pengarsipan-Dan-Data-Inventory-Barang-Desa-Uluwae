...
{    
    ...
    //  var_dump($data['tampil']);die;
      $data['judul'] = 'Halaman Cetak Arsip Surat Keluar';
      $this->load->view('template/header',$data);
      $this->load->view('template/sidebar',$data);
      $this->load->view('template/topbar',$data);
      $this->load->view('arskel/cet_periode',$data);
      $this->load->view('template/footer');
    }
    ...
    public function proses_periode()
    {
      ...
      $this->load->model('Arsip_model','arsip');
      $data['tampil'] = $this->arsip->periode($tglawal, $tglakhir);
      
    //  var_dump($data['tampil']);die;
      $data['judul'] = 'Halaman Arsip Keluar';
      $this->load->view('arskel/cetak_periode',$data);
    }
    ...
    //  var_dump($data['tampil']);die;
      $data['judul'] = 'Halaman Cetak Arsip Surat Masuk';
      $this->load->view('template/header',$data);
      $this->load->view('template/sidebar',$data);
      $this->load->view('template/topbar',$data);
      $this->load->view('arsip/cet_periode',$data);
      $this->load->view('template/footer');
    }
    ...
    public function proses_per()
    {
      ...
      $this->load->model('Arsip_model','arsip');
      $data['tampil'] = $this->arsip->perimasuk($tglawal, $tglakhir);
      
    //  var_dump($data['tampil']);die;
      $data['judul'] = 'Halaman Arsip Surat Masuk';
      $this->load->view('arsip/cetak_periode',$data);
    }
